  ...
  const [data, setData] = useState([
    {
      AñoRecibo: '2022',
      MesRecibo: '1',
      VendorPackslip_ID: '5456',
      Project_ID: '111002',
      Description: 'Planta Alimento 1 Silos y Almacén',
      Employee_ID: 'ADM72440',
      ReceiptEmployee_ID: 'ADM72440',
      Vendor_ID: 'PR12957',
      PO_Name: 'Jose Gonzalez Perez',
      Purch_Order_ID: 'OC22000164',
      Item_ID: '301100R-Granulado',
      Item_Name: 'Calcio Granulado',
      Años: '2022',
      PurchOrder_Date: 'ene',
      Unit_ofMeasure: 'Kg',
      UniCompra: '0.45',
      Pur_ConvFactor: '1000',
      AP_CurrencyRate: '1',
      SumaDeReceipt_Qty: '11.5',
      SumaDePOUnit_Price: '450',
      SumaDeImportePartida: '$5,175.00',
    },
    {
      AñoRecibo: '2022',
      MesRecibo: '1',
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          'http://192.168.100.20:3040/getAllMateriaPrima'
        );
...
export const getServerSideProps = async () => {
  ...
  const description = 'Dashboard de Medicamentos';
