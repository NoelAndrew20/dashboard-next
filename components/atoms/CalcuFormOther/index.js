        ...
        <div className="flex">
          <div className="modal-item w-1/3">
            ...
            <input
              ...
              type="text"
              name="NombreAlimento"
              value={nombreAlimentoV}
              onChange={(e) => setNombreAlimentoV(e.target.value)}
              required
            />
          </div>
          <div className="modal-item w-1/3">
            ...
            >
              ...
              <option value="complemento extra">
                Complemento extra alimento
              </option>
            </select>
          </div>
          <div className="modal-item w-1/3">
            ...
            <input
              ...
              name="proteina"
              value={proteinaV}
              onChange={(e) => setProteinaV(e.target.value)}
              required
            />
          </div>
        </div>
