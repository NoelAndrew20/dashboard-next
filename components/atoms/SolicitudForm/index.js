...
const SolicitudForm = ({ data, dataProveedor, setData, closeModal }) => {
  ...
  const handleProveedorChange = (event) => {
    const selectedProveedor = dataProveedor.find(
      (proveedor) => proveedor.nombreProveedor === event.target.value
    );
    setProveedorSeleccionado(selectedProveedor);
  };
  const handleProductoChange = (event) => {
    const selectedProducto = proveedorSeleccionado.productos.find(
      (producto) => producto.nombre === event.target.value
    );
    ...
    <>
      ...
      <form className="form-container pt-10">
            ...
            <div className="modal-cel">
              <div className="modal-item w-1/3">
                ...
                >
                  <input
                    type="text"
                    value={proveedorSeleccionado.Contacto.nombrePersona}
                    className={isDarkMode ? 'modal-input-d' : 'modal-input'}
              ...
              <div className="modal-item w-1/3">
                ...
                >
                  <input
                    type="text"
                    value={proveedorSeleccionado.Contacto.correo}
                    className={isDarkMode ? 'modal-input-d' : 'modal-input'}
              ...
              <div className="modal-item w-1/3">
                ...
                >
                  <input
                    type="text"
                    value={proveedorSeleccionado.Contacto.numeroTelefono}
                    className={isDarkMode ? 'modal-input-d' : 'modal-input'}
            ...
            <div className="modal-cel">
              <div className="modal-item w-1/3">
                ...
                >
                  <input
                    type="text"
                    value={proveedorSeleccionado.direccion.calle}
                    className={isDarkMode ? 'modal-input-d' : 'modal-input'}
              ...
              <div className="modal-item w-1/3">
                ...
                >
                  <input
                    type="text"
                    value={proveedorSeleccionado.direccion.numero}
                    className={isDarkMode ? 'modal-input-d' : 'modal-input'}
              ...
              <div className="modal-item w-1/3">
                ...
                >
                  <input
                    type="text"
                    value={proveedorSeleccionado.direccion.colonia}
                    className={isDarkMode ? 'modal-input-d' : 'modal-input'}
            ...
            <div className="modal-cel">
              <div className="modal-item w-1/3">
                ...
                >
                  <input
                    type="text"
                    value={proveedorSeleccionado.direccion.municipio}
                    className={isDarkMode ? 'modal-input-d' : 'modal-input'}
              ...
              <div className="modal-item w-1/3">
                ...
                >
                  <input
                    type="text"
                    value={proveedorSeleccionado.direccion.estado}
                    className={isDarkMode ? 'modal-input-d' : 'modal-input'}
              ...
              <div className="modal-item w-1/3">
                ...
                >
                  <input
                    type="text"
                    value={proveedorSeleccionado.direccion.codigoPostal}
                    className={isDarkMode ? 'modal-input-d' : 'modal-input'}
              ...
              <div className="modal-item w-1/3">
                ...
                >
                  <select
                    ...
                    name="productos"
                    onChange={(e) => {
                      handleProductoChange, setNombreAlimento(e.target.value);
                    }}
                  >
        ...
        <div className="modal-cel pt-3">
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="fechaSolicitud" className="modal-label">
          ...
          <div className="modal-item w-1/3">
            ...
            >
              <select
                ...
                name="nivelEntrega"
                value={nivelEntrega}
                onChange={(e) => setNivelEntrega(e.target.value)}
                required
              >
                <option value=""></option>
          ...
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="nombreSolicitante" className="modal-label">
