    ...
    <>
      ...
      <form className="form-container pt-10">
          ...
          <div className="modal-item w-1/3">
            ...
            >
              <input
                ...
                className={isDarkMode ? 'modal-input-d' : 'modal-input'}
                value={inputPsw}
                onChange={(event) => setInputPsw(event.target.value)}
                required
              />
            </div>
          </div>
        ...
        <div className="modal-cel">
          ...
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="apellidop" className="modal-label">
                Apellido Paterno:
              </label>
            </div>
            <div
          ...
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="apellidom" className="modal-label">
                Apellido Materno:
              </label>
            </div>
            <div
            ...
            >
              <input
                ...
                name="apellidom"
                className={isDarkMode ? 'modal-input-d' : 'modal-input'}
                value={inputLastNamedos}
                onChange={(event) => setInputLastNamedos(event.target.value)}
                required
              />
            </div>
          </div>
        ...
        <div className="modal-cel">
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="fechaNacimiento" className="modal-label">
                Fecha de Nacimiento:
              </label>
            </div>
            <div
            ...
            >
              <input
                ...
                className={isDarkMode ? 'modal-input-d' : 'modal-input'}
                value={inputBirth}
                onChange={(event) => setInputBirth(event.target.value)}
                required
              />
            </div>
          </div>
          <div className="modal-item w-1/3">
            ...
            >
              <select
                ...
                className={isDarkMode ? 'modal-input-d' : 'modal-input'}
                value={inputGenre}
                onChange={(event) => setInputGenre(event.target.value)}
                required
              >
        ...
        <div className="modal-cel">
          ...
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="responsabilidad" className="modal-label">
                Responsabilidad:
              </label>
            </div>
            <div
            ...
            >
              <input
                ...
                onChange={(event) =>
                  setInputResponsabilidad(event.target.value)
                }
                required
              />
            </div>
          ...
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="salario" className="modal-label">
                Salario Dario:
              </label>
            </div>
            <div
        ...
        <div className="modal-cel">
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="horario" className="modal-label">
                Horario:
              </label>
            </div>
            <div
            ...
            >
              <input
                ...
                className={isDarkMode ? 'modal-input-d' : 'modal-input'}
                value={inputSchedule}
                onChange={(event) => setInputSchedule(event.target.value)}
                required
              />
            </div>
          </div>
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="fecha-contratacion" className="modal-label">
            ...
            >
              <input
                type="date"
                id="fecha-contratacion"
                name="fecha-contratacion"
                className={isDarkMode ? 'modal-input-d' : 'modal-input'}
                value={inputHireDate}
                onChange={(event) => setInputHireDate(event.target.value)}
                required
              />
            </div>
          </div>
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="departamento" className="modal-label">
                Departamento:
              </label>
            </div>
            <div
            ...
            >
              <input
                ...
                onChange={(event) => setInputDepartment(event.target.value)}
                required
              />
            </div>
          </div>
        ...
        <div className="modal-cel">
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="statu" className="modal-label">
                Estatus:
              </label>
            </div>
          ...
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="contacto" className="modal-label">
                Contacto:
              </label>
            </div>
            <div
        ...
        <div className="modal-cel">
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="numeroI" className="modal-label">
                Numero Interior:
              </label>
            </div>
            <div
            ...
            >
              <input
                ...
                className={isDarkMode ? 'modal-input-d' : 'modal-input'}
                value={inputNumeroI}
                onChange={(event) => setInputNumeroI(event.target.value)}
                required
              />
            </div>
          </div>
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="numeroE" className="modal-label">
                Numero Exterior:
              </label>
            </div>
            <div
            ...
            >
              <input
                ...
                className={isDarkMode ? 'modal-input-d' : 'modal-input'}
                value={inputNumeroE}
                onChange={(event) => setInputNumeroE(event.target.value)}
                required
              />
            </div>
          </div>
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="ciudad" className="modal-label">
                Ciudad:
              </label>
            </div>
            <div
        ...
        <div className="modal-cel">
          ...
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="cp" className="modal-label">
                Código postal:
              </label>
            </div>
            <div
            ...
            >
              <input
                ...
                className={isDarkMode ? 'modal-input-d' : 'modal-input'}
                value={inputCp}
                onChange={(event) => setInputCp(event.target.value)}
                required
              />
            </div>
          </div>
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="tarea" className="modal-label">
                Tarea:
              </label>
            </div>
            <div
        ...
        <div className="modal-cel">
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="epp" className="modal-label">
            ...
            >
              <input
                ...
                className={isDarkMode ? 'modal-input-d' : 'modal-input'}
                value={inputEPP}
                onChange={(event) => setInputEPP(event.target.value)}
                required
              />
            </div>
          </div>
          <div className="modal-item w-1/3">
            <div>
              <label htmlFor="area" className="modal-label">
                Área:
              </label>
            </div>
            <div
