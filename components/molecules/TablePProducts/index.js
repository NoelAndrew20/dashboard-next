            ...
            <div>
              <div className="flex">
                  <div className="modal-item w-1/3">
                      <p>SKU:</p><input className={isDarkMode ? "edit-input-container-d" : "edit-input-container"} id="SKU" name="SKU" value={editedValues.SKU || ''} onChange={handleEditInputChange} />
                  </div>
                  <div className="modal-item w-1/3">
                  ...
                  <div className="modal-item w-1/3">
                      <p>Unidad:</p> <input className={isDarkMode ? "edit-input-container-d" : "edit-input-container"} name="unidad" value={editedValues.unidad || ''} onChange={handleEditInputChange} />
                  </div>
              </div>
                <div className="flex">
                  <div className="modal-item w-1/3">
                      <p>Precio:</p><input className={isDarkMode ? "edit-input-container-d" : "edit-input-container"} name="precio" value={editedValues.precio || ''} onChange={handleEditInputChange} />
                  </div>
