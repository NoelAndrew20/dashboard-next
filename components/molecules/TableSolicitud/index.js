...
const TableSolicitud = ({ data, setData }) => {
  ...
  const displayData = searchTerm
    ? data?.filter(
        (item) =>
          item.fechaSolicitud &&
          item.fechaSolicitud.toLowerCase().includes(searchTerm)
      )
    : data;
            ...
            <div className="flex">
              <div className="modal-item w-1/3">
                ...
                <input
                  ...
                  type="date"
                  name="fechaSolicitud"
                  value={editedValues.fechaSolicitud || ''}
              ...
              <div className="modal-item w-1/3">
                ...
                <input
                  ...
                  name="organizacion"
                  value={editedValues.organizacion || ''}
                  onChange={handleEditInputChange}
                />
              </div>
              <div className="modal-item w-1/3">
            ...
            <div className="flex">
              <div className="modal-item w-1/3">
                ...
                <select
                  ...
                  name="nivelEntrega"
                  value={editedValues.nivelEntrega || ''}
                  onChange={handleEditInputChange}
                >
            ...
            <div className="flex">
              <div className="modal-item w-1/3">
                ...
                <input
                  ...
                  value={editedValues.nombreSolicitante || ''}
                  onChange={handleEditInputChange}
                />
              </div>
            </div>
